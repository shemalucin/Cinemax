  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#0f0f10] via-[#111114] to-[#0a0a0a] shadow-[0_20px_80px_rgba(0,0,0,0.7)] md:flex animate-fade-in"
      >
        <button
          id="close-choice-modal-btn"
          onClick={onClose}
          aria-label="Close"
          className="absolute right-4 top-4 z-20 rounded-full bg-black/60 border border-white/10 p-2 text-neutral-400 hover:text-white hover:border-white/20 transition-colors cursor-pointer"
        >
          <X className="h-4 w-4" />
        </button>
        ...
        <div id="choice-modal-content-panel" className="flex flex-1 flex-col justify-between p-6 md:p-8">
          <div>
            <span className="inline-block rounded-md bg-[#39FF14]/10 border border-[#39FF14]/30 text-[#39FF14] px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest mb-3">
              {isTv ? "TV Show" : "Movie"}
            </span>
            <h2 className="font-sans text-2xl font-bold tracking-tight text-white mb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
              <button
                ...
                className="group flex flex-col items-center justify-center rounded-2xl border border-[#39FF14]/40 bg-gradient-to-br from-[#39FF14]/15 to-[#39FF14]/5 p-4 text-center hover:from-[#39FF14]/25 hover:border-[#39FF14] transition-all cursor-pointer"
              >
                <div className="mb-2 rounded-full bg-[#39FF14] p-2.5 group-hover:scale-110 transition-transform">
                  <Play className="h-4 w-4 fill-black text-black ml-0.5" />
                </div>
                <span className="text-sm font-bold text-white">Watch Full Movie</span>
              ...
              <button
                ...
                className="group flex flex-col items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-center hover:border-white/25 hover:bg-white/[0.06] transition-all cursor-pointer"
              >
                <div className="mb-2 rounded-full bg-white/10 p-2.5 text-neutral-200 group-hover:scale-110 transition-transform">
                  <Film className="h-4 w-4" />
                </div>
                <span className="text-sm font-bold text-white">Watch Trailer</span>
                <span className="mt-1 text-[10px] text-neutral-400">Official preview</span>
              </button>
            </div>
          </div>
          ...
          <button
            ...
            className="flex items-center gap-2 self-center py-2 px-3 rounded-full hover:bg-white/5 transition-colors cursor-pointer"
          >
            {localRemember ? (
              <CheckSquare className="h-4 w-4 text-[#39FF14]" />
            ) : (
